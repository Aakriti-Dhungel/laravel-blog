<nav x-data="{ open: false, sidebarOpen: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div :class="{'block': sidebarOpen, 'hidden': !sidebarOpen}" class="sm:hidden fixed inset-0 z-50 bg-gray-800 bg-opacity-50">
        <div class="flex flex-col justify-between h-full bg-gray-900 p-4">
            <div class="flex items-center justify-between">
                ...
                <button @click="sidebarOpen = false" class="text-white text-2xl">×</button>
            </div>
            <div class="mt-4">
